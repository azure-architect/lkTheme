  ...
  return {
    ...
    Headers: function () {
      var _offset = function _offset() {
        ...
        (_core$getVars$elHead2 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead2 === void 0 || _core$getVars$elHead2.classList.add('position-absolute');
        ...
        (_core$getVars$elHead4 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead4 === void 0 || _core$getVars$elHead4.classList.remove('position-absolute');
      ...
      var _removeSticky = function _removeSticky() {
        ...
        if (!((_core$getVars$elHead5 = __core.getVars.elHeaderWrap) !== null && _core$getVars$elHead5 !== void 0 && _core$getVars$elHead5.classList.contains('force-not-dark'))) {
          ...
          (_core$getVars$elHead6 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead6 === void 0 || _core$getVars$elHead6.classList.remove('not-dark');
        }
          ...
          for (i = 0; i < noOfNewClasses; i++) {
            if (newClassesArray[i] == 'not-dark') {
              ...
              if (!((_core$getVars$elHead7 = __core.getVars.elHeaderWrap) !== null && _core$getVars$elHead7 !== void 0 && _core$getVars$elHead7.classList.contains('.not-dark'))) {
                ...
                (_core$getVars$elHead8 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead8 === void 0 || _core$getVars$elHead8.classList.add('not-dark');
              }
            } else if (newClassesArray[i] == 'dark') {
              var _core$getVars$elHead9;
              (_core$getVars$elHead9 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead9 === void 0 || _core$getVars$elHead9.classList.remove('not-dark force-not-dark');
      ...
      return {
        init: function init(selector) {
          ...
          if (!headerWrapClone) {
            ...
            (_core$getVars$elHead10 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead10 === void 0 || _core$getVars$elHead10.parentNode.insertBefore(headerWrapClone, (_core$getVars$elHead11 = __core.getVars.elHeaderWrap) === null || _core$getVars$elHead11 === void 0 ? void 0 : _core$getVars$elHead11.nextSibling);
    ...
    Menus: function () {
      var _init = function _init() {
        ...
        document.addEventListener('click', function (e) {
          ...
          if (!e.target.closest('.primary-menu.on-click')) {
            ...
            onClickMenuCurrent === null || onClickMenuCurrent === void 0 || onClickMenuCurrent.forEach(function (current) {
              current === null || current === void 0 || current.classList.add('current');
            });
          }
          if (!e.target.closest('.top-links.on-click')) {
            ...
            onClickTopMenuCurrent === null || onClickTopMenuCurrent === void 0 || onClickTopMenuCurrent.forEach(function (current) {
              current === null || current === void 0 || current.classList.add('current');
            });
          }
        }, false);
      ...
      var _reset = function _reset() {
        ...
        __core.getVars.elPrimaryMenus.forEach(function (el) {
          ...
          if (!body.classList.contains('is-expanded-menu')) {
            ...
            (_el$querySelector = el.querySelector('.menu-container')) === null || _el$querySelector === void 0 || _el$querySelector.classList.remove('d-block');
          } else {
            var _el$querySelector2, _el$querySelectorAll;
            (_el$querySelector2 = el.querySelector('.menu-container')) === null || _el$querySelector2 === void 0 || _el$querySelector2.classList.remove('d-block', 'd-none');
            (_el$querySelectorAll = el.querySelectorAll(subMenusSel)) === null || _el$querySelectorAll === void 0 || _el$querySelectorAll.forEach(function (item) {
            ...
            __core.getVars.elPrimaryMenus.forEach(function (el) {
              ...
              (_el$querySelectorAll2 = el.querySelectorAll('.mobile-primary-menu')) === null || _el$querySelectorAll2 === void 0 || _el$querySelectorAll2.forEach(function (elem) {
                elem.classList.remove('d-block');
              });
            });
          }
          (_el$querySelectorAll3 = el.querySelectorAll(subMenusSel)) === null || _el$querySelectorAll3 === void 0 || _el$querySelectorAll3.forEach(function (item) {
            item.classList.remove('d-block');
          });
      ...
      var _withIcon = function _withIcon() {
        document.querySelectorAll('.mega-menu-content, .sub-menu-container').forEach(function (subMenu) {
          subMenu.querySelectorAll('.menu-item').forEach(function (item) {
            ...
            (link === null || link === void 0 ? void 0 : link.querySelector('i')) && ((_link$querySelector = link.querySelector('span')) === null || _link$querySelector === void 0 ? void 0 : _link$querySelector.classList.add('menu-subtitle-icon-offset'));
          });
        });
      };
      ...
      var _invert = function _invert(subMenuEl) {
        ...
        subMenus.forEach(function (el) {
          var _el$closest;
          primaryMenus = (_el$closest = el.closest('.header-row')) === null || _el$closest === void 0 ? void 0 : _el$closest.querySelectorAll('.primary-menu');
        ...
        (_primaryMenus = primaryMenus) === null || _primaryMenus === void 0 || _primaryMenus.forEach(function (pMenu) {
      ...
      var _current = function _current(triggerEl, menuItemSel, subMenusSel, subMenuTriggerSel) {
        ...
        var setCurrent = function setCurrent(item, menuItemSel, subMenusSel) {
          if (!__core.isHidden(item.closest(menuItemSel).querySelector(':scope > ' + subMenusSel))) {
            ...
            (_item$closest$querySe = item.closest(menuItemSel).querySelector(':scope > ' + subMenuTriggerSel)) === null || _item$closest$querySe === void 0 || _item$closest$querySe.classList.add('icon-rotate-90');
          } else {
            var _item$closest$querySe2;
            item.closest(menuItemSel).classList.remove('current');
            (_item$closest$querySe2 = item.closest(menuItemSel).querySelector(':scope > ' + subMenuTriggerSel)) === null || _item$closest$querySe2 === void 0 || _item$closest$querySe2.classList.remove('icon-rotate-90');
          }
        };
      ...
      var _schemeChanger = function _schemeChanger(activeSlide) {
        ...
        if (activeSlide.classList.contains('dark')) {
          ...
          if (__core.getVars.elBody.classList.contains('dark')) {
            ...
            (_document$querySelect3 = document.querySelector('#header.transparent-header:not(.sticky-header,.semi-transparent,.floating-header)')) === null || _document$querySelect3 === void 0 || _document$querySelect3.querySelector('#header-wrap').classList.add('not-dark');
          } else {
            document.querySelector('#header.transparent-header:not(.semi-transparent,.floating-header)').classList.remove('dark');
            __core.getVars.elHeaderWrap.classList.remove('not-dark');
          }
    ...
    TopSearch: function () {
      return {
        init: function init(selector) {
          ...
          (_searchForm$closest = searchForm.closest('.header-row')) === null || _searchForm$closest === void 0 || _searchForm$closest.classList.add('top-search-parent');
          ...
          selector[0].onclick = function (e) {
            ...
            (_document$getElementB = document.getElementById('top-cart')) === null || _document$getElementB === void 0 || _document$getElementB.classList.remove('top-cart-open');
            __core.getVars.recalls.menureset();
            if (__core.getVars.elBody.classList.contains('top-search-open')) {
              topSearchParent === null || topSearchParent === void 0 || topSearchParent.classList.add('position-relative');
            } else {
              timeout = setTimeout(function () {
                topSearchParent === null || topSearchParent === void 0 || topSearchParent.classList.remove('position-relative');
              }, 500);
            }
      ...
      var _load = function _load(portPostId, prevPostPortId, getIt) {
        ...
        if (getIt == false) {
          ...
          fetch(portfolioDataLoader).then(function (response) {
            ...
            nextPortfolio === null || nextPortfolio === void 0 || nextPortfolio.classList.add('d-none');
            prevPortfolio === null || prevPortfolio === void 0 || prevPortfolio.classList.add('d-none');
            if (portNext) {
              nextPortfolio === null || nextPortfolio === void 0 || nextPortfolio.setAttribute('data-id', portNext);
              nextPortfolio === null || nextPortfolio === void 0 || nextPortfolio.classList.remove('d-none');
            }
            if (portPrev) {
              prevPortfolio === null || prevPortfolio === void 0 || prevPortfolio.setAttribute('data-id', portPrev);
              prevPortfolio === null || prevPortfolio === void 0 || prevPortfolio.classList.remove('d-none');
            }
     ...
     */
    Grid: function () {
      var _reLayout = function _reLayout(el) {
        ...
        init: function init(selector) {
          ...
          selector.forEach(function (element) {
            ...
            fetch(elLoader + '?username=' + elUser).then(function (response) {
              ...
              if (_typeof(tweets) === 'object' && !tweets.isArray()) {
                return false;
              }
              alert.remove();
              var i = 0;
              tweets === null || tweets === void 0 || tweets.some(function (tw) {
                if (i == Number(elCount)) {
                  return;
                }
    ...
    OnePage: function () {
      ...
      var _scroller = function _scroller(el, type) {
        var clicker = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
        var section = _getSection(el, type),
      ...
      var _position = function _position() {
        ...
        __core.getVars.elOnePageMenus && __core.getVars.elOnePageMenus.forEach(function (el) {
          ...
          (_el$querySelector3 = el.querySelector('[data-href="#' + _current() + '"]')) === null || _el$querySelector3 === void 0 || _el$querySelector3.closest(__core.getVars.elOnePageParentSelector).classList.add(__core.getVars.elOnePageActiveClass);
        });
      };
      ...
      var _settings = function _settings(section, element) {
        ...
        parentSettings.offset = (parent === null || parent === void 0 ? void 0 : parent.getAttribute('data-offset')) || defaults.offset;
        parentSettings.speed = (parent === null || parent === void 0 ? void 0 : parent.getAttribute('data-speed')) || defaults.speed;
        parentSettings.easing = (parent === null || parent === void 0 ? void 0 : parent.getAttribute('data-easing')) || defaults.easing;
        var elementSettings = {
    ...
    Cookies: function () {
      ...
      return {
        init: function init(selector) {
          ...
          elSwitches === null || elSwitches === void 0 || elSwitches.forEach(function (el) {
          ...
          (_document$querySelect4 = document.querySelectorAll('.gdpr-container')) === null || _document$querySelect4 === void 0 || _document$querySelect4.forEach(function (element) {
            ...
            if (typeof getCookie !== 'undefined' && getCookie == '1' && cookiesAllowed) {
              ...
              if (elContentAjax) {
                fetch(elContentAjax).then(function (response) {
                  ...
                  element === null || element === void 0 || element.insertAdjacentHTML('beforeend', parsedHTML.body.innerHTML);
                })["catch"](function (err) {
                  console.log(err);
                });
              } else {
    ...
    PricingSwitcher: function () {
      ...
      var _switcher = function _switcher(check, switcher, pricing, defClass, actClass) {
        ...
        value = _staticValue;
        (_switcher$querySelect = switcher.querySelectorAll('.pts-switch')) === null || _switcher$querySelect === void 0 || _switcher$querySelect.forEach(function (elem) {
        ...
        (_pricing$querySelecto = pricing.querySelectorAll('.pts-content')) === null || _pricing$querySelecto === void 0 || _pricing$querySelecto.forEach(function (elem) {
          elem.classList.add('d-none');
        });
        if (check.type == 'checkbox') {
        ...
        defClass.split(" ").forEach(function (_class) {
          ...
          (_switcher$querySelect2 = switcher.querySelector('.pts-' + value)) === null || _switcher$querySelect2 === void 0 || _switcher$querySelect2.classList.remove(_class);
        });
        actClass.split(" ").forEach(function (_class) {
          var _switcher$querySelect3;
          (_switcher$querySelect3 = switcher.querySelector('.pts-' + value)) === null || _switcher$querySelect3 === void 0 || _switcher$querySelect3.classList.add(_class);
        });
    ...
    AjaxTrigger: function () {
      var _load = function _load(params) {
        fetch(params.loader).then(function (response) {
          ...
          if (params.placement == 'append') {
            ...
            (_params$container = params.container) === null || _params$container === void 0 || _params$container.insertAdjacentHTML('beforeend', parsedHTML.body.innerHTML);
          } else {
            var _params$container2;
            (_params$container2 = params.container) === null || _params$container2 === void 0 || _params$container2.insertAdjacentHTML('afterbegin', parsedHTML.body.innerHTML);
          }
          ...
          var _params$container3;
          var errorDIV = document.createElement("div");
          errorDIV.classList.add('d-inline-block', 'text-danger', 'me-3');
          errorDIV.innerText = 'Content Cannot be Loaded!';
          (_params$container3 = params.container) === null || _params$container3 === void 0 || _params$container3.prepend(errorDIV, ': ' + err);
        });
      };
      var _scripts = function _scripts() {
        var loadCSS = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
        var loadJS = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        if (loadCSS) {
    ...
    TextSplitter: function () {
      ...
      var _splitter = function _splitter(el) {
        ...
        (_el$querySelectorAll4 = el.querySelectorAll('span')) === null || _el$querySelectorAll4 === void 0 || _el$querySelectorAll4.forEach(function (elem, index) {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/functions.bundle.js");
/******/ 	
/******/ })()
;