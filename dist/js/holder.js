...
!function (e) {
  ...
  return function (e) {
    ...
    (function (t) {
      ...
      function i(e, t) {
        var n = {
            theme: T(O.settings.themes.gray, null),
        ...
        if (n.fluid = a.indexOf("p") !== -1, n.dimensions = {
          ...
          if (n.auto = w.truthy(l.auto), l.bg && (n.theme.bg = w.parseColor(l.bg)), l.fg && (n.theme.fg = w.parseColor(l.fg)), l.bg && !l.fg && (n.autoFg = !0), l.theme && n.instanceOptions.themes.hasOwnProperty(l.theme) && (n.theme = T(n.instanceOptions.themes[l.theme], null)), l.text && (n.text = l.text), l.textmode && (n.textmode = l.textmode), l.size && parseFloat(l.size) && (n.size = parseFloat(l.size)), l.font && (n.font = l.font), l.align && (n.align = l.align), l.lineWrap && (n.lineWrap = l.lineWrap), n.nowrap = w.truthy(l.nowrap), n.outline = w.truthy(l.outline), w.truthy(l.random)) {
            ...
            n.theme = T(n.instanceOptions.themes[c], null);
          }
        }
        return n;
      }
      function o(e) {
        ...
        var m = r.holderURL,
          v = T(i, null);
        if (r.font && (s.font = r.font, !v.noFontFallback && "img" === n.nodeName.toLowerCase() && O.setup.supportsCanvas && "svg" === v.renderer && (v = T(v, {
          renderer: "canvas"
      ...
      function c() {
        ...
        r.forEach(function (t) {
          e = O.vars.invisibleImages[t], k(e) && "img" == e.nodeName.toLowerCase() && (n.push(e), delete O.vars.invisibleImages[t]);
        }), n.length && j.run({
          images: n
        }), setTimeout(function () {
        ...
        z = function () {
          ...
          return function (r) {
            ...
            if (O.setup.supportsSVG) {
              ...
              null != e && e.parentNode === document.body || (o = !0), e = b.initSVG(e, i.properties.width, i.properties.height), e.style.display = "block", o && (t = x.newEl("text", F), n = a(null), x.setAttr(t, {
                x: 0
              ...
              var h = x.newEl("textarea");
              h.innerHTML = l.text, n.nodeValue = h.value;
              var u = t.getBBox(),
                c = Math.ceil(u.width / i.properties.width),
                d = l.text.split(" "),
                f = l.text.match(/\\n/g);
              c += null == f ? 0 : f.length, n.nodeValue = l.text.replace(/[ ]+/g, "");
              ...
              if (c > 1) {
                n.nodeValue = "";
                for (var y = 0; y < d.length; y++) if (0 !== d[y].length) {
                  n.nodeValue = w.decodeHtmlEntity(d[y]);
                  var S = t.getBBox();
                  v.push({
                    text: d[y],
                    width: S.width
      ...
      for (var M in O.flags) O.flags.hasOwnProperty(M) && (O.flags[M].match = function (e) {
      ...
      O.setup = {
        ...
        e.getContext && e.toDataURL("image/png").indexOf("data:image/png") != -1 && (O.setup.renderer = "canvas", O.setup.supportsCanvas = !0), document.createElementNS && document.createElementNS(F, "svg").createSVGRect && (O.setup.renderer = "svg", O.setup.supportsSVG = !0);
      }(), d(), m && m(function () {
        O.vars.preempted || j.run(), t.addEventListener ? (t.addEventListener("resize", g, !1), t.addEventListener("orientationchange", g, !1)) : t.attachEvent("onresize", g), "object" == _typeof(t.Turbolinks) && t.document.addEventListener("page:change", function () {
          j.run();
        });
      }), e.exports = j;
    }).call(t, function () {
    ...
    e.exports = function (e, t) {
      ...
      var S = c.element({
        ...
        T = a(E);
      /\&amp;(x)?#[0-9A-Fa-f]/.test(T[0]) && (T[0] = T[0].replace(/&amp;#/gm, "&#")), T = h + T[0];
    ...
    e.exports = function r(e, t, n) {
      ...
      for (; d < e.length; d++) {
        ...
        if (void 0 !== e[d] && e[d] !== !0) if ("string" == typeof e[d]) f && (e[d] = s(e[d])), e[0].children.push(e[d]);else if ("number" == typeof e[d]) e[0].children.push(e[d]);else if (Array.isArray(e[d])) {
          ...
          for (h in e[d]) e[d].hasOwnProperty(h) && null !== e[d][h] && e[d][h] !== !1 && ("style" === h && "object" == _typeof(e[d][h]) ? e[0].attr[h] = JSON.stringify(e[d][h], o).slice(2, -2).replace(/","/g, ";").replace(/":"/g, ":").replace(/\\"/g, "'") : e[0].attr[h] = e[d][h]);
        }
      }
      if (e[0] !== !1) {
        l = "<" + e[0].tag;
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/holder.js");
/******/ 	
/******/ })()
;