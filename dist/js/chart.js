...
!function (t, e) {
  ...
  var _ = function _(t) {
    return t instanceof _ ? t : this instanceof _ ? (this.valid = !1, this.values = {
      ...
      cmyk: [0, 0, 0, 0],
      alpha: 1
    }, void ("string" == typeof t ? (e = d.getRgba(t)) ? this.setValues("rgb", e) : (e = d.getHsla(t)) ? this.setValues("hsl", e) : (e = d.getHwb(t)) && this.setValues("hwb", e) : "object" == _typeof(t) && (void 0 !== (e = t).r || void 0 !== e.red ? this.setValues("rgb", e) : void 0 !== e.l || void 0 !== e.lightness ? this.setValues("hsl", e) : void 0 !== e.v || void 0 !== e.value ? this.setValues("hsv", e) : void 0 !== e.w || void 0 !== e.whiteness ? this.setValues("hwb", e) : void 0 === e.c && void 0 === e.cyan || this.setValues("cmyk", e)))) : new _(t);
    var e;
  };
  _.prototype = {
  ...
  var hi = xn.extend({
      ...
      determineDataLimits: function determineDataLimits() {
        ...
        for (t = 0, n = (l.data.datasets || []).length; t < n; ++t) if (l.isDatasetVisible(t)) {
          if (a = l.data.datasets[t].data, H.isObject(a[0])) for (m[t] = [], e = 0, i = a.length; e < i; ++e) r = li(s, a[e]), g.push(r), m[t][e] = r;else m[t] = p.slice(0), o || (g = g.concat(p), o = !0);
        } else m[t] = [];
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/chart.js");
/******/ 	
/******/ })()
;